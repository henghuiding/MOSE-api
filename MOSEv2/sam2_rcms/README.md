...
| MODEL | $\mathcal{J} \text{\&} \dot{\mathcal{F}}$ | $\mathcal{J}$ | $\dot{\mathcal{F}}$ | $\mathcal{J}\&\dot{\mathcal{F}}_d$ | $\mathcal{J}\&\dot{\mathcal{F}}_r$ | $\mathcal{F}$ | $\mathcal{J}\&\mathcal{F}$ | Weights | Submission |
|-------|----|----|----|----|----|----|----|---------| ---------- |
